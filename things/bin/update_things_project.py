...
def update_project():
    ...
    Code from: https://github.com/tendenci/tendenci/blob/master/tendenci/bin/update_tendenci_project.py
    Source License: https://github.com/tendenci/tendenci/blob/master/LICENSE.md
    """
